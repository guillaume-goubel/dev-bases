...
echo  "La " .$voiture1->get_marque() ." semble s'arreter et diminue sa vitesse de " .$voiture1->_vitesse ." km/h pour être définitivement à " .$voiture1->arret() ." km/h" ."<br>";
array_push($compteur_voiture1,$voiture1->_vitesse);

echo  "La " .$voiture3->get_marque() ." semble s'arreter et diminue sa vitesse de " .$voiture3->_vitesse ." km/h pour être définitivement à " .$voiture3->arret() ." km/h" ."<br>";
array_push($compteur_voiture3,$voiture3->_vitesse);

echo $voiture1->demarrer("off") ."<br>";
echo $voiture3->demarrer("off") ."<br>"; 

echo "<h2>" .$voiture1->get_conducteur() ." au volant de son véhicule " .$voiture1->get_marque() ."a été à un maximum de " .max($compteur_voiture1) . "km/h <h2> <br>" ;
echo "<h2>" .$voiture2->get_conducteur() ." au volant de son véhicule " .$voiture2->get_marque() ."a été à un maximum de " .max($compteur_voiture2) . "km/h <h2> <br>" ;
echo "<h2>" .$voiture3->get_conducteur() ." au volant de son véhicule " .$voiture3->get_marque() ."a été à un maximum de " .max($compteur_voiture3) . "km/h <h2> <br>" ;
